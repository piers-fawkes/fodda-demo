      ...
      >
        ...
        <div className="flex-1 overflow-y-auto overflow-x-hidden py-3 px-2 space-y-0.5 scrollbar-hide">
          ...
          <div>
            <SectionHeader
              label="Demo Area"
              isExpanded={expandedSections.demo || isInGroup('sandbox') || isInGroup('live-requests') || activeView === 'expert-chat'}
            ...
            />
            <div className={`space-y-0.5 overflow-hidden transition-all duration-200 ${(expandedSections.demo || activeView === 'sandbox' || activeView === 'live-requests' || activeView === 'expert-chat') ? 'max-h-[300px] opacity-100' : 'max-h-0 opacity-0'}`}>
              <NavItem label="Expert Chat" onClick={() => { onNavigate('expert-chat'); onClose(); }} isActive={isActive('expert-chat')} indent />
              <NavItem label="Research Graphs" onClick={() => { onNavigate('sandbox'); onClose(); }} isActive={isActive('sandbox') || isActive('live-requests')} indent />
            </div>
          </div>
        ...
        <div className="px-3 py-3 border-t border-line shrink-0 space-y-2">
          ...
          <p className="text-[9px] text-ink-4 font-mono px-3">Fodda Console v2.0</p>
        </div>
