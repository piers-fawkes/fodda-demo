            ...
            <div className="p-3 rounded-xl bg-amber-50 border border-amber-200 flex items-center justify-between gap-3">
                <div className="flex items-center gap-3 flex-1 min-w-0">
                    ...
                    <p className="text-sm text-amber-800">
                        You've used <span className="font-bold">{used.toLocaleString()}</span> of <span className="font-bold">{limit.toLocaleString()}</span> API calls. Add a payment method to keep querying{rateLabel ? ` at ${rateLabel}` : ''} beyond your limit.
                    </p>
                </div>
